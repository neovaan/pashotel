    ...
    <div class="row">
        ...
        <div class="col-md-2 col-sm-6">
            <div class="form-group">
                <div class="input-group" id="ch-ad-cus">
                    <div class="input-group-addon" ><?php echo $texts['PERSON']; ?></div>
        ...
        <div class="col-md-2 col-sm-12">
            <div class="form-group">
                <button class="btn btn-block btn-primary" type="submit" name="check_availabilities">FIND</button>
            </div>
        </div>
    </div>
</form>
