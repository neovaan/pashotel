                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-contact">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" name="msg" placeholder="<?php echo $texts['MESSAGE']; ?> *" rows="5"><?php echo htmlentities($msg, ENT_QUOTES, "UTF-8"); ?></textarea>
                            </div>
                            <div class="field-notice" rel="msg"></div>
                        </div>    
                        <div class="form-contact form-inline">
