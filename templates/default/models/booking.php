                ...
                <div class="container boxed mb20 booking-result">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-5">
                            <h3 style="font-size:18px"><?php echo $hotel_title; ?></h3>
                        ...
                        <div class="col-md-12">
                            <a data-toggle="collapse" data-target="#collapse-<?php echo $id_hotel; ?>" href="#collapse-<?php echo $id_hotel; ?>" class="btn-toggle btn-warning">
                                <i class="fa fa-angle-down"></i>
                            </a>
                        </div>
                        <div class="col-md-12 panel-collapse" id="collapse-<?php echo $id_hotel; ?>">
                            <div class="boxed">
                                <?php
                                $result_room->execute();
